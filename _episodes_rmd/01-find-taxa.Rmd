...
Indeed, R is telling us that the output of `tnrs_match_names()` is a data frame (a type of table) and a **'match_names' object**, which is in turn a data frame with exactly `r ncol(resolved_names)` named columns: `search_string`, `unique_name`, `approximate_match`, `ott_id`, `is_synonym`, `flags`, and `number_matches`.
<!-- `r paste0("**", colnames(resolved_names)[-7], "**")`, and `r paste0("**", colnames(resolved_names)[7], "**")`. -->
